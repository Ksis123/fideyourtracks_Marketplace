      ...
      <div className="flex-1 bg-white p-6 flex flex-col justify-between">
        ...
        <div className="overflow-hidden mb-4">
          <dl className="-mx-4 -mt-4 flex flex-wrap">
            <div className="flex flex-col px-4 pt-4">
              ...
              <dd className="order-1 text-xl font-extrabold text-primary">
        ...
        <div>
          <button
            ...
            type="button"
            className="disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none disabled:cursor-not-allowed mr-2 inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-primary hover:bg-active focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
          >
            Buy
          </button>
          <button
